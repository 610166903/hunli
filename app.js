...
function startIntroAutoPlay() {
  if (!introVideo || isIntroComplete || introAutoPlayFrame) return;
...
if (introVideo) {
  ...
  introVideo.addEventListener("canplay", () => setIntroVideoProgress(introProgress));
